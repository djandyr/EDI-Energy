...
namespace Proengeno\EdiEnergy\Utilmd\U11092;

use DateTime;
use Proengeno\EdiEnergy\Utilmd\UtilmdBuilder;

class UtilmdU11092Builder extends UtilmdBuilder
{
    const CHECK_DIGIT = 11092;

    public function getDescriptionPath()
    {
        return __DIR__ . '/UtilmdU11092Description.php';
    }
