...
namespace Proengeno\EdiEnergy\Utilmd\U11150;

use DateTime;
use Proengeno\EdiEnergy\Utilmd\UtilmdBuilder;
use Proengeno\EdiEnergy\Interfaces\Utilmd\SupplierBalancingChangeInterface;

class UtilmdU11150Builder extends UtilmdBuilder
{
    const CHECK_DIGIT = 11150;

    public function getDescriptionPath()
    {
        return __DIR__ . '/UtilmdU11150Description.php';
    }
