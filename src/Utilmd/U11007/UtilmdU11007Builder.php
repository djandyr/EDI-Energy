...
namespace Proengeno\EdiEnergy\Utilmd\U11007;

use DateTime;
use Proengeno\EdiEnergy\Utilmd\UtilmdBuilder;

class UtilmdU11007Builder extends UtilmdBuilder
{
    const CHECK_DIGIT = 11006;

    protected $descriptionPath = __DIR__ . '/UtilmdU11007.php';
