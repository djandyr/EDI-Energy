...
namespace Proengeno\EdiEnergy\Utilmd\U11093;

use DateTime;
use Proengeno\EdiEnergy\Utilmd\UtilmdBuilder;

class UtilmdU11093Builder extends UtilmdBuilder
{
    const CHECK_DIGIT = 11094;

    public function getDescriptionPath()
    {
        return __DIR__ . '/UtilmdU11093Description.php';
    }
