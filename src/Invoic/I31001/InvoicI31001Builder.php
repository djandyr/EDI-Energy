...
namespace Proengeno\EdiEnergy\Invoic\I31001;

use DateTime;
use Proengeno\EdiEnergy\Invoic\InvoicBuilder;
use Proengeno\EdiEnergy\Interfaces\Invoic\AcceptedPaymentsInterface;

class InvoicI31001Builder extends InvoicBuilder
{
    const CHECK_DIGIT = 31001;

    public function getDescriptionPath()
    {
        return __DIR__ . '/InvoicI31001Description.php';
    }
