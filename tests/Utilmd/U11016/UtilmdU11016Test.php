...
class UtilmdU11016Test extends TestCase
{
    ...
    {
        $this->utilmdBuilder = new UtilmdU11016Builder('from', 'to', tempnam(sys_get_temp_dir(), 'EdifactTest'));
    }
    ...
    public function it_build_up_the_Message_instance_with_utilmd_13002_mapping()
    {
        ...
        $this->assertEquals('UtilmdU11016', $this->edifactObject->getAdapterName());
    }
