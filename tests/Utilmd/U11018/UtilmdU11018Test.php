...
class UtilmdU11018Test extends TestCase
{
    ...
    {
        $this->utilmdBuilder = new UtilmdU11018Builder('from', 'to', tempnam(sys_get_temp_dir(), 'EdifactTest'));
    }
    ...
    public function it_build_up_the_Message_instance_with_utilmd_13002_mapping()
    {
        ...
        $this->assertEquals('UtilmdU11018', $this->edifactObject->getAdapterName());
    }
