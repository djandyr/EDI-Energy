...
class UtilmdU11010Test extends TestCase
{
    ...
    {
        $this->utilmdBuilder = new UtilmdU11010Builder('from', 'to', tempnam(sys_get_temp_dir(), 'EdifactTest'));
    }
    ...
    public function it_build_up_the_Message_instance_with_utilmd_13002_mapping()
    {
        ...
        $this->assertEquals('UtilmdU11010', $this->edifactObject->getAdapterName());
    }
