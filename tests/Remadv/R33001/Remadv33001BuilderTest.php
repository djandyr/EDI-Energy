...
namespace Proengeno\EdiEnergy\Test\Remadv\R33001;
...
class Remadv33001BuilderTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->remadvBuilder = new RemadvR33001Builder('to', $this->configuration, tempnam(sys_get_temp_dir(), 'EdifactTest'));
    }
    ...
    public function it_converts_the_input_to_iso_and_the_output_from_iso_to_utf8()
    {
        ...
        $remadvBuilder = new RemadvR33001Builder('to', $this->configuration, $filename);
    ...
    public function compare_with_template_gas_invoice()
    {
        ...
        $remadvBuilder = new RemadvR33001Builder('to', $this->configuration, tempnam(sys_get_temp_dir(), 'EdifactTest'));
    ...
    {
        return "UNA:+.? 'UNB+UNOC:3+from:502+to:502+" . date('ymd:Hi') . "+UNB-REF'UNH+UNB-REF0+REMADV:D:05A:UN:2.7c'BGM+481+UNB-REF0'DTM+137:" . date('Ymd') . ":102'RFF+Z13:33001'NAD+MS+from::332'CTA+IC+:Frau Jacobs'COM+04958 91570-08:TE'COM+a.jacobs@proengeno.de:EM'NAD+MR+to::332'CUX+2:EUR:11'DOC+380+1'MOA+9:10.00'MOA+12:10.00'DTM+137:20150101:102'DOC+380+1'MOA+9:10.00'MOA+12:15.50'DTM+137:20150101:102'UNS+S'MOA+12:25.50'UNT+21+UNB-REF0'UNH+UNB-REF1+REMADV:D:05A:UN:2.7c'BGM+481+UNB-REF1'DTM+137:" . date('Ymd') . ":102'RFF+Z13:33001'NAD+MS+from::332'CTA+IC+:Frau Jacobs'COM+04958 91570-08:TE'COM+a.jacobs@proengeno.de:EM'NAD+MR+to::332'CUX+2:EUR:11'DOC+380+1'MOA+9:10.00'MOA+12:15.50'DTM+137:20150101:102'DOC+380+1'MOA+9:10.00'MOA+12:15.50'DTM+137:20150101:102'UNS+S'MOA+12:56.50'UNT+21+UNB-REF1'UNZ+2+UNB-REF'";
    }

    private function getElectricInvoiceTemplate()
    {
        return "UNA:+.? 'UNB+UNOC:3+from:500+to:500+" . date('ymd:Hi') . "+UNB-REF'UNH+UNB-REF0+REMADV:D:05A:UN:2.7c'BGM+481+UNB-REF0'DTM+137:" . date('Ymd') . ":102'RFF+Z13:33001'NAD+MS+from::293'CTA+IC+:Frau Jacobs'COM+04958 91570-08:TE'COM+a.jacobs@proengeno.de:EM'NAD+MR+to::293'CUX+2:EUR:11'DOC+380+1'MOA+9:10.00'MOA+12:10.00'DTM+137:20150101:102'DOC+380+1'MOA+9:10.00'MOA+12:15.50'DTM+137:20150101:102'UNS+S'MOA+12:25.50'UNT+21+UNB-REF0'UNH+UNB-REF1+REMADV:D:05A:UN:2.7c'BGM+481+UNB-REF1'DTM+137:" . date('Ymd') . ":102'RFF+Z13:33001'NAD+MS+from::293'CTA+IC+:Frau Jacobs'COM+04958 91570-08:TE'COM+a.jacobs@proengeno.de:EM'NAD+MR+to::293'CUX+2:EUR:11'DOC+380+1'MOA+9:10.00'MOA+12:15.50'DTM+137:20150101:102'DOC+380+1'MOA+9:10.00'MOA+12:15.50'DTM+137:20150101:102'UNS+S'MOA+12:56.50'UNT+21+UNB-REF1'UNZ+2+UNB-REF'";
    }
}
